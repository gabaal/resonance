...
# curl -X POST "https://gabaal--chatterbox-tts-chatterbox-serve.modal.run/generate" \
#   -H "Content-Type: application/json" \
#   -H "X-Api-Key: @WatchBottle13@" \
#   -d '{"prompt": "Hello from Chatterbox [chuckle].", "voice_key": "voices/system/cmmdoejwt0000cs9ly11t8h9c"}' \
#   --output output.wav

# R2 cloud bucket mount (read-only, replaces Modal Volume)
R2_BUCKET_NAME = "resonance-app"
R2_ACCOUNT_ID = "2a176fb1ce8c89c6c5c6235c4c693429"
R2_MOUNT_PATH = "/r2"
